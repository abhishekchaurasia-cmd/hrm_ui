...
import { useAssignEmployeesToPolicy } from '../hooks/use-time-tracking-policies';
...
export function AssignEmployeesDialog({
  ...
  const mutation = useAssignEmployeesToPolicy(policyId);
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Select employees to assign to this time tracking policy.
          </DialogDescription>
        </DialogHeader>
